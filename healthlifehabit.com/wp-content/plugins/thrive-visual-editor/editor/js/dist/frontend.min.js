...
var TVE_jQFn = {},
    TCB_Front = {
        tableSort: function(a) {
            a.on("click", function() {
                function b(a, b) {
                    return a.text == b.text ? a.oText > b.oText ? 1 : a.oText < b.oText ? -1 : 0 : a.text > b.text ? 1 : -1
                }
                ...
                d.attr("data-direction", j), ThriveGlobal.$j(f).find("tbody tr").each(function() {
                    var a = ThriveGlobal.$j(this),
                        b = a.find("> td").eq(e).text().trim().replace(/\u200B/g, "").toLowerCase(),
                        c = parseFloat(b);
                    isNaN(c) ? h.push({
                        tr: a,
                        text: b,
        ...
        postGridLayout: function() {
            ...
            var b = ThriveGlobal.$j(".tve_post_grid_grid");
            b.length <= 0 || b.find(".tve_pg_row").each(function() {
                var a = 0,
        ...
        changeAutoplayVideo: function(a) {
            var b, c = this;
            b = void 0 === a ? ThriveGlobal.$j(".thrv_responsive_video") : a.find(".thrv_responsive_video"), b.each(function() {
                if (!tve_frontend_options.is_editor_page) {
                    var a = ThriveGlobal.$j(this);
                    a.parents(".tve_p_lb_content").length || c.makeAutoplayVideo(a)
                }
            })
        },
        makeAutoplayVideo: function(a) {
            var b, c, d, e = a.attr("data-type");
            if ("1" === a.attr("data-autoplay")) {
                switch (e) {
                    case "youtube":
                    case "vimeo":
                        c = "&autoplay=1";
                ...
                "youtube" === e || "vimeo" === e || "wistia" === e ? (b = a.find("iframe"), d = b.attr("src"), 0 !== d.length && (b.attr("src", d + c), b.attr("data-src", d + c))) : "custom" !== e && "self" !== e || a.find("video").get(0).play()
            }
        },
        isValidUrl: function(a) {
            return /(http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/.test(a)
        },
        pageSectionHeight: function() {
            var a = TCB_Front.$window;
            ThriveGlobal.$j(".pdfbg.pdwbg").css({
                "box-sizing": "border-box",
                height: a.height() + "px"
            }), ThriveGlobal.$j(".pddbg").css("max-width", a.width() + "px"), ThriveGlobal.$j(".pddbg.pdfbg").each(function() {
                var a = ThriveGlobal.$j(this).css("height", ""),
                    b = a.attr("data-height"),
                    c = a.attr("data-width");
                if (void 0 !== b && void 0 !== c) {
                    var d = a.parent().width(),
                        e = d * b / c;
                    d <= c ? a.css("min-height", e + "px") : a.css({
                        "min-height": b + "px"
                    })
                }
            })
        ...
        openLightbox: function(a, b) {
            function c(a, b) {
                ...
                }), void 0 === b && 1 === ThriveGlobal.$j(".tve_lb_open").length && (e.removeClass(g).css("padding-right", ""), f.removeClass(g)), a.removeClass("tve_lb_open tve_lb_opening").addClass("tve_lb_closing"), setTimeout(function() {
            ...
            function d(b) {
                var c, d, e = a.find(".tve_p_lb_content"),
                    f = TCB_Front.$window.height(),
                    g = void 0 !== b && b ? "animate" : "css";
            ...
            var e = ThriveGlobal.$j("body"),
                ...
                i = this,
                j = parseInt(e.css("padding-right")),
                k = a.find("input[placeholder]");
            k.length && k.thrive_iphone_placeholder(), a.find(".thrv_responsive_video").each(function() {
                var a = ThriveGlobal.$j(this);
                i.makeAutoplayVideo(a)
            }), a.off().on("click", ".tve_p_lb_close", function() {
                return c(a), !1
            }), e.off("keyup.tve_lb_close").on("keyup.tve_lb_close", function(b) {
                if (27 == b.which) return c(a), !1
            }), a.children(".tve_p_lb_overlay").off("click.tve_lb_close").on("click.tve_lb_close", function() {
                return c(a), !1
            }), c(ThriveGlobal.$j(".tve_p_lb_background.tve_lb_open"), !0), a.addClass("tve_p_lb_background tve_lb_anim_" + b), e.addClass(g), f.addClass(g), TCB_Front.$window.height() < ThriveGlobal.$j(document).height() && e.css("padding-right", j + h + "px"), a.find(".tve_scT").length ? a.find(".tve_scT").each(function() {
                var a = ThriveGlobal.$j(this),
            ...
            window.TVE_Event_Manager_Registered_Callbacks && a.find(".tve_evt_manager_listen").each(function() {
                ...
                try {
                    b = ThriveGlobal.$j.parseJSON(b.replace("__TCB_EVENT_", "").replace("_TNEVE_BCT__", "")), ThriveGlobal.$j.each(b, function(b, c) {
                        if (TVE_Event_Manager_Registered_Callbacks[c.a]) {
                            var d = "mouseover" === c.t ? "mouseenter" : c.t;
                            a.off(d + ".tcbevt" + c.t).on(d + ".tcbevt" + c.t, function() {
                                return TVE_Event_Manager_Registered_Callbacks[c.a].call(a[0], c.t, c.a, c.config ? c.config : {})
                            })
                        }
                    })
                } catch (a) {
                    console.log("Could not parse events"), console.log(a)
                }
            })
        },
        show_data_elemements: function(a) {
            tve_frontend_options.is_editor_page || ThriveGlobal.$j(".thrv_data_element").filter(":not(.thrv_data_element_start)").each(function() {
                var b = ThriveGlobal.$j(this),
                    c = TCB_Front.$window.height();
                a + c >= b.offset().top + b.outerHeight() && "hidden" !== b.css("visibility") && b.addClass("thrv_data_element_start").trigger("tve.start-animation")
            })
        },
        onDOMReady: function(a) {
            function b() {
                h.filter(":not(.tve-recapcha-rendered)").each(function() {
                    var a = ThriveGlobal.$j(this),
            ...
            void 0 === a && (a = ThriveGlobal.$j("body")), ThriveGlobal.$j(".tcb-video-background-el").each(function() {
            ...
            if (d.each(function() {
                    ...
                    var a = ThriveGlobal.$j(this);
                    a.find("ul").css("z-index", e + 6), a.parents() ? a.parents().each(function() {
                        var a = ThriveGlobal.$j(this);
                        "static" !== a.css("position") && a.css("z-index", e + 7)
                    }) : a.css("z-index", e + 8), e--
                ...
                var f = null;
                TCB_Front.getCookie("account_create_fields") && "null" != TCB_Front.getCookie("account_create_fields") && function() {
                    function a() {
                        TCB_Front.setCookie("account_create_fields", null, {
                            path: "/"
                        })
                    }
                    var b = decodeURIComponent(TCB_Front.getCookie("account_create_fields"));
                    b = JSON.parse(b), f = b, ThriveGlobal.$j.each(b, function(a, b) {
                        var c = ThriveGlobal.$j("body").find("input[name=" + b.name + "]");
                        c.val(b.value).hide(), c.parent().append('<div class="tve-editable-field"><p>' + b.value + '</p><span class="tve_sc_icon icon-lock tve-edit-field"></span></div>')
                    }), setTimeout(a, 2500)
                }(), ThriveGlobal.$j(document).on("tl-ajax-loaded", function() {
                    function a() {
                        TCB_Front.setCookie("account_create_fields", null, {
                            path: "/"
                        })
                    }
                    f && (ThriveGlobal.$j.each(f, function(a, b) {
                        var c = ThriveGlobal.$j("body").find("input[name=" + b.name + "]");
                        c.val(b.value).hide(), c.val(b.value).closest("form").find(".tve-editable-field").is(":visible") || c.parent().append('<div class="tve-editable-field"><p>' + b.value + '</p><span class="tve_sc_icon icon-lock tve-edit-field"></span></div>')
                    }), setTimeout(a, 2500))
                    ...
                    }), c < 30 ? (d = "#ef5350", e = "Weak", a = b.next().find(".tve-password-strength").first()) : c >= 30 && c < 60 ? (d = "#ffa726", e = "So-so", a = b.next().find(".tve-password-strength:lt(2)")) : c >= 60 && c < 80 ? (d = "#8bc34a", e = "Good", a = b.next().find(".tve-password-strength:lt(3)")) : (d = "#4caf50", e = "Great!", a = b.next().find(".tve-password-strength:lt(4)")), a.each(function() {
                ...
                var g = function(a) {
                    var b, c = 0,
                        ...
                        e = 0;
                    if (!a) return c;
                    for (var f = 0; f < a.length; f++) d[a[f]] = (d[a[f]] || 0) + 1, c += 5 / d[a[f]];
                    b = {
                        digits: /\d/.test(a),
                        lower: /[a-z]/.test(a),
                        upper: /[A-Z]/.test(a),
                    ...
                    for (var g in b) e += 1 == b[g] ? 1 : 0;
                    return c += 10 * (e - 1), parseInt(c)
                };
                ThriveGlobal.$j(document).on("click", ".tve-edit-field", function() {
                    ...
                    var a = ThriveGlobal.$j(this).parent();
                    a.is("a") || a.find("img").trigger("click")
                }), ThriveGlobal.$j(document).on("mouseenter mouseout", ".tve-image-overlay", function(a) {
                    ThriveGlobal.$j(this).parent().find("img").trigger(a.type)
                    ...
                    ThriveGlobal.$j(this).on("tve.start-animation", function() {
                        function a(b, d) {
                            b <= d ? (c.text(b), b += h, b + h > d && (c.text(d), clearTimeout(g)), g = setTimeout(function() {
                                a(b, d)
                            }, 50)) : clearTimeout(g)
                        }

                        function b(a, d) {
                            a >= d ? (c.text(a), a -= h, a - h < d && (c.text(d), clearTimeout(g)), g = setTimeout(function() {
                                b(a, d)
                            }, 50)) : clearTimeout(g)
                        }
                ...
                ThriveGlobal.$j(".tve_p_lb_content").find("video").each(function() {
                    ...
                    var f = function() {
                        setTimeout(function() {
                            a.slideDown(200, function() {
                                ...
                                var a = ThriveGlobal.$j(this);
                                a.attr("src") || d && e || a.attr("src", a.attr("data-src"))
                            }), TCB_Front.changeAutoplayVideo(a), a.trigger("tve-content-revealed")
                        }, 1e3 * b)
                    };
                    c.length ? c.bind("tve.lightbox-open", f) : f()
                }), ThriveGlobal.$j(".thrv_tw_qs").tve_front_tw_qs(), ThriveGlobal.$j(".thrv-countdown_timer_evergreen, .tve_countdown_timer_evergreen").thrive_tcb_timer(), ThriveGlobal.$j(".thrv-countdown_timer_plain, .thrv_countdown_timer:not(.tve_countdown_timer_evergreen)").thrive_tcb_timer(), ThriveGlobal.$j(".thrv_lead_generation").tve_front_lead_generation(), setTimeout(function() {
                    try {
                        ThriveGlobal.$j(".tve_typefocus").each(function() {
                            var a = ThriveGlobal.$j(this),
                                b = [],
                                c = parseInt(a.attr("data-speed")),
                                d = a.attr("data-colors");
                            0 !== a.attr("data-typist").length && (b.push(a.text()), b = b.concat(a.attr("data-typist").split("|")), a.typed({
                                strings: b,
                                loop: !0,
                                typeSpeed: 125,
                                backSpeed: 50,
                                highlightClass: 1 === parseInt(a.attr("data-highlight")) ? "tve_selected_typist" : "",
                                highlightStyle: 1 === parseInt(a.attr("data-highlight")) && d ? "background-color:" + d : "",
                                backDelay: c,
                                contentType: "text",
                                startDelay: 800,
                ...
                }, 1e3), a.find(".thrv_responsive_video").off().click(function() {
                    var a, b, c, d = ThriveGlobal.$j(this),
                        e = d.find(".video_overlay_image"),
                        f = d.attr("data-type");
                    switch (f) {
                        case "youtube":
                        case "vimeo":
                    ...
                    if ("youtube" === f || "vimeo" === f || "wistia" === f) a = d.find("iframe"), c = a.attr("src"), 0 !== c.length && a.attr("src", c + b);
                    else if ("custom" === f || "self" === f) {
                        var g = d.find("video").get(0);
            ...
            if (TCB_Front.changeAutoplayVideo(), ThriveGlobal.$j(".thrv_responsive_video:hidden").find("video").each(function() {
                    ThriveGlobal.$j(this)[0].pause()
                }), TCB_Front.postGridLayout(), TCB_Front.$window.on("load", function() {
                    ...
                    try {
                        ThriveGlobal.$j(".tve_typefocus").each(function() {
                            var b = ThriveGlobal.$j(this),
                                c = TCB_Front.$window.height();
                            b.data("typed") && (a + c >= b.offset().top && b.offset().top > a || "start" == b.attr("data-typefocus") ? b.typed("start") : (b.attr("data-typefocus"), b.typed("pause")))
                        })
                    } catch (a) {
                        console.log(a)
                    }
                }), TCB_Front.$window.trigger("scroll"), !tve_frontend_options.is_editor_page) {
                var h = ThriveGlobal.$j(".tve-captcha-container");
                if (h.length) {
                    var i = !1;
                    window.tve_gapi_loaded || (ThriveGlobal.$j.getScript("https://www.google.com/recaptcha/api.js?render=explicit", c), i = !0, window.tve_gapi_loaded = !0), i || c()
                }
                var j = ThriveGlobal.$j(".tve-fb-comments");
                j.length && (ThriveGlobal.$j("#fb-root").length && ThriveGlobal.$j("head").append('<div id="fb-root"></div>'), j.each(function() {
                ...
                var k = ThriveGlobal.$j(".thrv_disqus_comments #disqus_thread");
                k.length && (window.disqus_shortname = k.attr("data-disqus_shortname"), "" == k.attr("data-disqus_url") ? window.disqus_url = window.location : window.disqus_url = k.attr("data-disqus_url"), window.disqus_identifier = window.disqus_url, "undefined" == typeof DISQUS && ThriveGlobal.$j.getScript("//" + disqus_shortname + ".disqus.com/embed.js"))
            }
        ...
        resizePageSection: function(a) {
            void 0 === a && (a = ThriveGlobal.$j(".tcb-window-width")), a.each(function() {
                var a = ThriveGlobal.$j(this),
                    b = (a.parent().width(), a.find(".tve-page-section-in"), a.css("left"));
                b = "auto" === b ? 0 : Number(a.css("left").replace("px", "")), a.css({
                    width: TCB_Front.$window.width() + "px",
                    left: -a.offset().left + b + "px"
                })
            })
        },
        onSocialCustomClick: {
            wnd: function(a, b, c) {
                var d = void 0 !== window.screenLeft ? window.screenLeft : screen.left,
            ...
            fb_share: function(a) {
                var b = a.data();
                if (b.href || (b.href = location.href), b.type && "feed" != b.type) this.wnd("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(b.href), 650, 500);
                else {
                    var c = "";
                    b.name && (c += "&title=" + encodeURIComponent(b.name)), b.description && (c += "&description=" + encodeURIComponent(b.description)), b.href && (c += "&u=" + encodeURIComponent(b.href)), b.caption && (c += "&caption=" + encodeURIComponent(b.caption)), b.image && (c += "&picture=" + encodeURIComponent(b.image)), c = "?" + c.substr(1), this.wnd("https://www.facebook.com/sharer.php" + c, 650, 500)
                }
                return !1
            },
            g_share: function(a) {
                var b = a.data();
                b.href || (b.href = location.href), this.wnd("https://plus.google.com/share?url=" + encodeURIComponent(b.href), 600, 600)
            },
            t_share: function(a) {
                var b = a.data();
                b.href || (b.href = location.href), this.wnd("https://twitter.com/intent/tweet?url=" + encodeURIComponent(b.href) + (b.tweet ? "&text=" + encodeURIComponent(b.tweet) : "") + (b.via ? "&via=" + b.via : ""), 550, 450)
            },
            in_share: function(a) {
                var b = a.data();
                b.href || (b.href = location.href), this.wnd("https://www.linkedin.com/shareArticle?mini=true&url=" + encodeURIComponent(b.href), 550, 400)
            },
            pin_share: function(a) {
                var b = a.data();
                b.href || (b.href = location.href), this.wnd("https://pinterest.com/pin/create/button/?url=" + encodeURIComponent(b.href) + (b.media ? "&media=" + encodeURIComponent(b.media) : "") + (b.description ? "&description=" + encodeURIComponent(b.description) : ""), 600, 600)
            },
            xing_share: function(a) {
                var b = a.data();
                b.href || (b.href = location.href), this.wnd("https://www.xing.com/spi/shares/new?url=" + encodeURIComponent(b.href), 600, 500)
            }
        },
        getShareCounts: function(a, b, c) {
            ...
            if (d.length) {
                ...
                if (void 0 !== b ? ThriveGlobal.$j.each(b, function(a, b) {
                        e[a] = b
                        ...
                        if (c.hasOwnProperty("t_share") && 1 === f.length) return f.removeClass("tve_count_loading"), d.remove(), void b.parent().removeAttr("data-counts");
                        e.for[a] = c
                ...
                var f = function(a) {
                    a && a.counts && a.totals && d.each(function(b) {
                        ...
                        if (ThriveGlobal.$j.each(a.counts[b], function(a, b) {
                            ...
                            f = isNaN(f) ? 0 : f, d.find(".tve_s_cnt").html(a.totals[b].formatted), f < a.totals[b].value ? d.css("display", "inline-block") : d.css("display", "none")
                        }
                        a.totals && a.totals[b] && (TCB_Front.total_share_counts[e.attr("data-href")] = a.totals[b])
                    })
                };
                if (void 0 !== c && c) return [e, f];
                ThriveGlobal.$j.ajax({
                    type: "post",
                    xhrFields: {
                        withCredentials: !0
        ...
        playBackgroundYoutube: function(a) {
            if (a.length) {
                var b = this;
                void 0 !== window.YT && window.YT.Player ? this._playYTBackground(a) : (window.onYouTubeIframeAPIReady = function() {
                    b._playYTBackground(a)
                }, ThriveGlobal.$j.ajax({
        ...
        _playYTBackground: function(a) {
            a.each(function() {
                var a, b = this.getAttribute("data-yt-id");
                a = 34 === b.length ? new YT.Player(this.id, {
                    playerVars: {
                        autoplay: 1,
                        cc_load_policy: 0,
                        controls: 0,
                    ...
                    events: {
                        onReady: function(a) {
                            a.target.mute(), a.target.playVideo()
                        },
                        onStateChange: function(a) {
                            a.target && a.target.mute && a.target.mute()
                        }
                    }
                }), ThriveGlobal.$j(a.getIframe()).data("tcb-yt-player", a)
            })
        },
        refreshBackgroundYoutube: function() {
            if (window.YT && window.YT.Player) {
                ...
                ThriveGlobal.$j("iframe.tcb-yt-bg").each(function() {
                    var b = ThriveGlobal.$j(this);
                    b.data("tcb-yt-player") || a._playYTBackground(b)
                })
            }
        }
    };
TVE_jQFn.tve_front_tw_qs = function() {
        ...
        return window.TCB_PAGE_INDEX = window.TCB_PAGE_INDEX || 1, this.each(function() {
            ...
            if (0 == b.length && (a.find(".thrv_lead_generation_container").wrapInner('<form method="post"></form>'), b = a.find("form")), b.find('input[type="checkbox"],input[type="radio"]').each(function() {
                    if (!this.id) return !0;
                ...
                }), void 0 !== c && "#" == b.attr("action") && b.attr("action", c), a.data("tve_lg_done")) return this;
            if (a.data("tve_lg_done", !0), void 0 !== window.SegMet && SegMet && -1 !== b[0].action.indexOf("infusionsoft") && !b.data("tve-segmet-submit")) {
            ...
            var e = {
                    ...
                    phone: function(a, b) {
                        return !a.val().replace(/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{3,6}$/im, "").length || (this._markError(a, b, "phone"), !1)
                    },
                    required: function(a, b) {
                        return !!("radio" === a.attr("type") ? ThriveGlobal.$j('input[name="' + a.attr("name") + '"]').is(":checked") : "checkbox" === a.attr("type") ? a.is(":checked") : ThriveGlobal.$j.trim(a.val()).length > 0) || (this._markError(a, b, "required"), !1)
                    },
                    password: function(a, b) {
                        var c = !0;
                        return a.val() || 1 !== a.data("required") || (c = !1), !!c || (this._markError(a, b, "password"), !1)
                    },
                    mismatch: function(a, b) {
                        var c = !0;
                        return a.password != a.confirm_password && (c = !1), !!c || (this._markError("", b, "passwordmismatch"), !1)
                    },
                    email: function(a, b) {
                        return !!/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(a.val()) || (this._markError(a, b, "email"), !1)
                    },
                ...
                f = function(a, c) {
                    var d = ThriveGlobal.$j.extend({
                            success: "Success!",
                            error: "Error!"
                        }, c),
                        e = b.find("#_form_type").val(),
                        f = b.find("input[name=name]").val() ? b.find("input[name=name]").val() : "",
                        g = b.find("input[name=email]").val();
                    if (a) {
                        b.parents(".tl-style").first().find(".tve_p_lb_close").trigger("click");
                        var h = ThriveGlobal.$j.Event("leads_messages.tcb");
                        b.trigger(h), "lead_generation" == e && (b.find("input").val(""), b.parents(".tve_p_lb_content").find(".tve_p_lb_close").click()), d.success = d.success.replace("[lead_email]", g), d.success = d.success.replace("[lead_name]", f), jQuery("body").slideDown("fast", function() {
                            jQuery("body").prepend('<div class="tvd-toast tve-fe-message"><div class="tve-toast-message"><div class="tve-toast-icon-container"><span class="tve_tick thrv-icon-checkmark"></span></div><div class="tve-toast-message-container">' + d.success + "</div></div></div>")
                        }), setTimeout(function() {
                        ...
                        var i = b.parent(),
                            j = i.parent(),
                            k = j.find(".tve-error-wrapper");
                        1 == b.find("#_error_message_option").val() ? (i.hide(), 0 == k.length ? (j.append('<div class="tve-error-wrapper"><div class="tve-error-content"></div><button class="tve-close-error-message">Retry</button></div>'), d.error = d.error.replace("[lead_email]", g), d.error = d.error.replace("[lead_name]", f), j.find(".tve-error-content").append(d.error)) : j.find(".tve-error-wrapper").show()) : location.reload()
                    }
                    b.tve_form_loading(!0)
                };
            ! function() {
                a.data("form-target") && a.data("form-target").length && a.find("form").attr("target", a.data("form-target"))
            }(), a.find(".tve-lg-err-msg").length && function() {
                var c = e.getErrors(a);
                b.submit(function(a) {
                    if (b.data("tve-force-submit")) return !0;
                    var d = !0,
                        g = ThriveGlobal.$j(this),
                        h = {};
                    if (e.init(), g.find("input, select, textarea").each(function() {
                            var a = ThriveGlobal.$j(this),
                                b = a.data("validation"),
                                f = a.data("required"),
                                g = a.data("iphone-placeholder");
                            "" !== g && a.val() === g && a.val(""), "password" == a.attr("type") && (h[a.attr("name")] = a.val()), 1 === f && (e.required(a, c.required) || (d = !1)), void 0 !== b && "none" !== b && e[b] && (e[b](a, c[b]) || (d = !1))
                        }), g.find("#g-recaptcha-response").length > 0 && "" == g.find("#g-recaptcha-response").val() && (e.markApiError("Please validate captcha form"), d = !1), 2 == Object.keys(h).length && (e.mismatch(h, c.passwordmismatch) || (d = !1)), !d) return e.show(), b.find("." + e.errClass).first().focus(), !1;
                    if (b.tve_form_loading(), "api" == b.parents(".thrv_lead_generation").attr("data-connection")) {
                        var i = b.serialize() + "&action=tve_api_form_submit&url=" + encodeURIComponent(location.href),
                            j = b.find("#_submit_option").val(),
                            k = ThriveGlobal.$j.Event("form_conversion.tcb");
                        b.trigger(k);
                        var l = b.find("#_autofill").val();
                        if (l) var m = b.find("input").not("input[type=hidden]").not("input[type=password]").serializeArray();
                        return k.post_data && (i += "&" + ThriveGlobal.$j.param(k.post_data)), tve_frontend_options.post_id && (i += "&post_id=" + tve_frontend_options.post_id), ThriveGlobal.$j.ajax({
                            type: "post",
                            xhrFields: {
                                withCredentials: !0
                            },
                            ...
                            try {
                                ...
                                var g = Object.keys(a).length > 0 && !a.error;
                                if (a.error) return void f(g, c)
                            } catch (a) {
                                console.log(a)
                            }
                            var h = ThriveGlobal.$j.Event("lead_conversion_success.tcb");
                            if (b.trigger(h), h.content_unlocked) return !1;
                            var i = b.find("#_error_message_option").val();
                            if (!j || "reload" === j && (g || 1 != i)) return void location.reload();
                            if ("redirect" === j) {
                                var k = b.find("#_back_url").val();
                                if (l && m && !isExternal(k) && TCB_Front.setCookie("account_create_fields", JSON.stringify(m), {
                                        path: "/"
                                    }), k && TCB_Front.isValidUrl(k) && (g || 1 != i)) return void(location.href = k)
                            } else {
                                if ("state" === j && g) {
                                    var n = TL_Front.parent_state,
                                        o = b.find(".tve-switch-state-trigger"),
                                        p = -1 !== o.attr("data-tcb-events").indexOf("tl_state_lightbox"),
                                        q = b.parents(".tve_post_lightbox").length > 0;
                                    if (o.trigger("click"), p)
                                        if (q) n && (TL_Front.close_form(n), delete TL_Front.parent_state);
                                        else {
                                            var r = ThriveGlobal.$j.Event("leads_messages.tcb");
                                            r.lightbox_state = !0, b.trigger(r), b.tve_form_loading(!0)
                                        }
                                ...
                                if ("klicktipp-redirect" == j && g) {
                                    if (d && TCB_Front.isValidUrl(d)) return void(location.href = d)
                                } else if ("page" == j && g && e && TCB_Front.isValidUrl(e)) return void(location.href = e)
                            }
                            return f(g, c), jQuery(".tve_lead_generated_inputs_container").parent()[0].reset(), !0
                        }), a.stopPropagation(), a.preventDefault(), !1
                    }
                    var n = ThriveGlobal.$j.Event("should_submit_form.tcb");
                    if (b.trigger(n), "1" !== b.find("input#_asset_option").val() && !n.flag_need_data) return !0;
                    var i = b.serialize() + "&action=tve_custom_form_submit&email=" + function(a) {
                            if (a.find('[data-validation="email"]').length) return a.find('[data-validation="email"]').val();
                            var b = "";
                            return a.find("input").each(function() {
                                if (this.name && this.name.match(/email/i)) return b = this.value, !1
                            }), b
                        }(b) + "&name=" + function(a) {
                            var b = !1;
                            return a.find("input").each(function() {
                                var a = ThriveGlobal.$j(this),
                                    ...
                                    d = a.attr("name");
                                if (c && -1 !== c.toLowerCase().indexOf("name") || d && -1 !== d.toLowerCase().indexOf("name")) return b = a, !1
                            }), !1 !== b ? b.val() : ""
                        }(b),
                        k = ThriveGlobal.$j.Event("form_conversion.tcb");
                    return b.trigger(k), k.post_data && (i += "&" + ThriveGlobal.$j.param(k.post_data)), tve_frontend_options.post_id && (i += "&post_id=" + tve_frontend_options.post_id), ThriveGlobal.$j.ajax({
                        type: "post",
                        xhrFields: {
                            withCredentials: !0
                        },
        ...
        return void 0 !== a && a ? (d.fadeOut(), b.find("input,select,textarea").removeAttr("disabled"), c.find("button").fadeIn(), this) : (d.length || (d = ThriveGlobal.$j('<div class="tcb-form-loader"><span class="tcb-form-loader-icon thrv-icon-spinner9"></span></div>').appendTo(c), c.css({
            position: "relative",
            width: c.width() + "px",
            height: c.height() + "px"
        ...
        return this.each(function() {
            ...
            var b, c = ThriveGlobal.$j(this),
                ...
                j = 2,
                k = c.attr("data-text"),
                l = c.hasClass("thrv-countdown_timer_evergreen") || c.hasClass("tve_countdown_timer_evergreen"),
            ...
            if (c.data("tcb_timer_done", !0), l) {
                ...
                if (r) {
                    ...
                    var t = e.getFullYear() + "-" + (e.getMonth() + 1) + "-" + e.getDate() + "-" + e.getHours() + "-" + e.getMinutes() + "-" + e.getSeconds(),
                        u = new Date("2034-01-01");
                    if (!parseInt(m)) {
                        var v = new Date(e.getTime());
                        u = v.setDate(e.getDate() + parseInt(c.attr("data-expday"))), u = v.setHours(e.getHours() + parseInt(c.attr("data-exphour"))), u = new Date(u)
                    }
            ...
            var w = function(a, b) {
                ...
                x = function(a, b, c) {
                    void 0 === c && (c = !1);
                    var d = 0;
                    if (b <= 99) w(a.find(".part-1").first(), b % 10), w(a.find(".part-2").first(), Math.floor(b / 10)), d = 2;
                    else
                        for (; b;) d++, w(a.find(".part-" + d).first(), b % 10), b = Math.floor(b / 10);
                    if (!1 !== c && d < c)
                        for (var e = d + 1; e <= c; e++) w(a.find(".part-" + e).first(), 0)
                },
                y = function() {
                    i--, i < 0 && (i = 59, h--), h < 0 && (h = 59, g--), g < 0 && (g = 23, f--), x(c.find(".tve_t_sec .t-digits"), i), x(c.find(".tve_t_min .t-digits"), h), x(c.find(".tve_t_hour .t-digits"), g), x(c.find(".tve_t_day .t-digits"), f, j), f <= 0 && g <= 0 && h <= 0 && i <= 0 && (f = g = h = i = 0, clearInterval(b), z())
                },
                z = function() {
            ...
            !l && d >= e ? z() : (i = Math.floor((e.getTime() - d.getTime()) / 1e3), h = Math.floor(i / 60), i %= 60, g = Math.floor(h / 60), h %= 60, f = Math.floor(g / 24), g %= 24, f > 99 && (j = f.toString().length), function() {
                var a = function(a, b) {
                ...
                for (var b = c.find(".tve_t_day .t-digits").empty(), d = f, e = 1; e <= j; e++) b.append(a(e, d % 10)), d = Math.floor(d / 10);
                b.css("min-width", "")
            }(), c.addClass("init_done"), b = setInterval(y, 1e3)), l && d >= e && (clearInterval(b), z())
        })
    ...
    }, void 0 !== ThriveGlobal && (TCB_Front.$window = ThriveGlobal.$j(window), ThriveGlobal.$j(document).ready(function() {
        function a() {
        ...
        b.on("click", ".tve_scT > ul li", function(a) {
            ...
            b.attr("data-tve-custom-colour", void 0 !== f && !1 !== f ? f : ""), e.attr("data-tve-custom-colour", void 0 !== g && !1 !== g ? g : ""), c.find("> ul .tve_tS").removeClass("tve_tS"), c.find("> .tve_scTC").hide(), b.addClass("tve_tS"), d.show(), TCB_Front.postGridLayout(), d.find("iframe").not(".thrv_social_default iframe").each(function() {
                var a = ThriveGlobal.$j(this);
                a.attr("data-src") && (a.attr("src", a.attr("data-src")), a.attr("data-src", ""), a.removeClass("tcb-dr-done"))
            }), TCB_Front.changeAutoplayVideo(d), c.find("> .tve_scTC").each(function(a) {
                if (a !== b.index()) {
                    var c = ThriveGlobal.$j(this);
            ...
            c.is(":visible") ? (c.find("iframe").not(".thrv_social_default iframe").each(function() {
                ...
                c.trigger("lbresize")
            }), TCB_Front.postGridLayout(), TCB_Front.changeAutoplayVideo(c), a.addClass("tve_oFaq"))
            ...
            return ThriveGlobal.$j(".tve-m-trigger").is(":visible") && ThriveGlobal.$j(".tve_w_menu").removeClass("tve-m-expanded"), !0
        }), b.on("click", ".tve-m-trigger", function() {
            return ThriveGlobal.$j(this).parent().find("> ul").toggleClass("tve-m-expanded"), !1
            ...
            TVE_Event_Manager_Registered_Callbacks[b.a] && ThriveGlobal.$j(document).on("tve-page-event-" + b.t, function(a, c) {
                var d = !0;
                return "timer" === b.t && c && b.config && b.config.t_delay !== c && (d = !1), !!d && TVE_Event_Manager_Registered_Callbacks[b.a].call(document, b.t, b.a, b.config ? b.config : {})
            })
        })), c.push(TCB_Front.postGridLayout), c.push(a), a()), TCB_Front.onDOMReady(), "undefined" == typeof ThriveApp && (TCB_Front.pageSectionHeight(), c.push(TCB_Front.pageSectionHeight)), c.push(TCB_Front.resizePageSection), TCB_Front.$window.resize(function() {
    ...
    function(a) {
        ...
        b.prototype = {
            ...
            init: function(a) {
                function b() {
                    for (var b = 0; b < c.strings.length; ++b) c.sequence[b] = b;
                    c.shuffle && (c.sequence = c.shuffleArray(c.sequence)), "delete" === a ? (c.strPos = c.strings[c.sequence[c.arrayPos]].length, c.options.highlightClass ? c.highlight(c.strings[c.sequence[c.arrayPos]], c.strPos) : c.backspace(c.strings[c.sequence[c.arrayPos]], c.strPos)) : (c.strPos = 0, c.typewrite(c.strings[c.sequence[c.arrayPos]], c.strPos))
                }
                void 0 === a && (a = "delete");
                var c = this;
                "delete" === a ? c.timeout = setTimeout(b, c.startDelay) : b()
            },
            build: function() {
                var b = this;
            ...
            typewrite: function(b, c) {
                if (!0 !== this.stop) {
                    var d = this.typeSpeed,
                        e = this;
                    a(this.el);
                    e.timeout = setTimeout(function() {
                        ...
                        if ("^" === d.charAt(0)) {
                            var f = 1;
                            /^\^\d+/.test(d) && (d = /\d+/.exec(d)[0], f += d.length, a = parseInt(d)), b = b.substring(0, c) + b.substring(c + f)
                        }
                        if ("html" === e.contentType) {
                            var g = b.substr(c).charAt(0);
                            if ("<" === g || "&" === g) {
                                var h = "",
                                    i = "";
                                for (i = "<" === g ? ">" : ";"; b.substr(c).charAt(0) !== i;) h += b.substr(c).charAt(0), c++;
                                c++, h += i
                            }
                        }
                        e.timeout = setTimeout(function() {
                            if (c === b.length) {
                                if (e.options.onStringTyped(e.arrayPos), e.arrayPos === e.strings.length - 1 && (e.options.callback(), e.curLoop++, !1 === e.loop || e.curLoop === e.loopCount)) return;
                                e.timeout = setTimeout(function() {
                                    e.options.highlightClass ? e.highlight(b, c) : e.backspace(b, c)
                                }, e.backDelay)
                            } else {
                                0 === c && e.options.preStringTyped(e.arrayPos);
                                var a = b.substr(0, c + 1);
                                e.attr ? e.el.attr(e.attr, a) : e.isInput ? e.el.val(a) : "html" === e.contentType ? e.el.html(a) : e.el.text(a), c++, e.typewrite(b, c)
                            }
                        }, a)
                    }, d)
                }
            ...
            highlight: function(b, c) {
                if (!0 !== this.stop) {
                    var d = this.backSpeed,
                        e = this;
                    a(e.el), a("<span/>");
                    e.timeout = setTimeout(function() {
                        if ("html" === e.contentType && ">" === b.substr(c).charAt(0)) {
                            for (var a = "";
                                "<" !== b.substr(c).charAt(0);) a -= b.substr(c).charAt(0), c--;
                            c--, a += "<"
                        }
                        var d = b.substr(0, c),
                            f = b.substr(c);
                        e.attr ? e.el.attr(e.attr, d) : e.el.html(d + '<span class="' + e.options.highlightClass + '" style="' + (e.options.highlightStyle || "") + '">' + f + "</span>"), c > e.stopNum ? (c--, e.highlight(b, c)) : c <= e.stopNum && setTimeout(function() {
                            e.arrayPos++, e.arrayPos === e.strings.length ? (e.arrayPos = 0, e.init("write")) : e.typewrite(e.strings[e.sequence[e.arrayPos]], c)
                        }, 200)
                    }, d)
                }
            },
            backspace: function(b, c) {
                if (!0 !== this.stop) {
                    var d = this.backSpeed,
                        e = this,
                        f = a(e.el);
